...
const SearchRequestSchema = z.object({
  ...
  minSurfaceM2: z.coerce.number().int().positive().optional(),
  maxSurfaceM2: z.coerce.number().int().positive().optional(),
  surfaceType: z.enum(["covered", "total"]).optional(),
  ...
  propertySubtypes: z.array(z.string().trim()).optional(),
  advertiserType: z.enum(["all", "agency", "owner"]).optional(),
  publicationDate: z.enum(["yesterday", "today", "last-week"]).optional(),
  age: z.enum(["under-construction", "new", "up-to-5-years"]).optional(),
  roomTypes: z.array(z.string().trim()).optional(),
  comforts: z.array(z.string().trim()).optional(),
  propertyFeatures: z.array(z.string().trim()).optional(),
  disposition: z.array(z.string().trim()).optional(),
  services: z.array(z.string().trim()).optional(),
  media: z.array(z.string().trim()).optional(),
  argenpropGeneralServices: z.array(z.string().trim()).optional(),
  ...
  pets: z.coerce.number().int().nonnegative().optional(),
  airbnbRoomTypes: z.array(z.string().trim()).optional(),
  airbnbAmenityIds: z.array(z.string().trim()).optional(),
  minBedrooms: z.coerce.number().int().positive().optional(),
  minBeds: z.coerce.number().int().positive().optional(),
  minAirbnbBathrooms: z.coerce.number().int().positive().optional(),
...
async function prepareSearchScan(data: SearchRequest) {
  ...
  if (data.mode === "filters") {
    ...
    const built = buildSearchUrl({
      ...
      minSurfaceM2: data.minSurfaceM2,
      maxSurfaceM2: data.maxSurfaceM2,
      ...
      media: data.media,
      argenpropGeneralServices: data.argenpropGeneralServices,
      ...
      pets: data.pets,
      airbnbRoomTypes: data.airbnbRoomTypes,
      airbnbAmenityIds: data.airbnbAmenityIds,
      minBedrooms: data.minBedrooms,
      minBeds: data.minBeds,
      minAirbnbBathrooms: data.minAirbnbBathrooms,
    });
    searchUrl = built.url;
